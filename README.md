# TgROI - Калькулятор эффективности рекламы в Telegram
...
- Интегральная оценка эффективности каналов
...
- Integral evaluation of channel efficiency
...
- Інтегральна оцінка ефективності каналів
